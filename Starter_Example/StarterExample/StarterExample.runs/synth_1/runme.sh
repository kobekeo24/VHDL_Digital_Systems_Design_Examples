...
HD_PWD='C:/Users/13372/Documents/GitHub/VHDL_Digital_Systems_Design_Examples/Starter_Example/StarterExample/StarterExample.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log First_System.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source First_System.tcl
