...
HD_PWD='C:/Users/13372/Documents/GitHub/VHDL_Digital_Systems_Design_Examples/Starter_Example/StarterExample/StarterExample.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log First_System.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source First_System.tcl -notrace
