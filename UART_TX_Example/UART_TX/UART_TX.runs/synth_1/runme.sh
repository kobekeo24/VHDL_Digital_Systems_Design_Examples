...
HD_PWD='C:/Users/13372/Documents/GitHub/VHDL_Digital_Systems_Design_Examples/UART_TX_Example/UART_TX/UART_TX.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log UART_tx_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source UART_tx_top.tcl
